...
import { selectIsLoggedIn } from '../../../redux/feetures/auth/authSlice';
import { getProduct } from '../../../redux/feetures/product/productSlice';
      ...
      <Card cardClass="card">
        ...
        {product && (
            <div className="detail">
                ...
                <h4 className="flex-h4">Product Availability: {stockStatus(product.quantity)}</h4>
                <hr />
                <h4>
